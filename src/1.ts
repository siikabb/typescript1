...
while (true) {
  ...
  const itemName: string = prompt("Insert item name (empty to stop)")!;
  ...
  const itemPrice: number = parseFloat(prompt("Insert item price")!);
  const itemQuantity: number = parseInt(prompt("Insert item quantity")!);
